      ...
      },
      {
        ...
        ways: [
          ...
          },
          {
            ...
            transfers: 1,
            /*
             * 갈아타는데도 이쪽을 추천으로 둔다 — **삿포로는 겨울 도시**라서다.
             * 눈이 오면 버스는 시간을 장담할 수 없고, JR 은 거의 그대로 온다.
             * 정시성이 초행자에게 가장 무난한 기준이라고 봤다.
             *
             * 여름에 짐이 크다면 버스가 나을 수 있다. 그래서 버스를 위에 두고
             * 「갈아타지 않는다」를 굵게 적어, 추천이 아니어도 눈에 걸리게 했다.
             */
            recommended: true,
