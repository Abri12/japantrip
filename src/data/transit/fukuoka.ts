...
export const FUKUOKA_PASSES: TransitPass[] = [
  ...
  },
  {
    ...
    worthIt:
      '하카타·텐진·오호리공원 위주로 다닌다면 범위는 이거면 충분하고, 한 번에 210~260엔이라 세 번만 타도 640엔을 넘겨요. 그런데 해외 신용카드를 그냥 개찰구에 대고 타도 같은 카드로 하루 640엔이 넘지 않아요. 1일권과 값이 똑같이 맞춰져 있어서, 터치 결제가 되는 카드가 있으면 이 표를 사러 발매기에 갈 이유가 없어요. 현금만 쓰거나 터치 결제가 안 되는 카드일 때의 선택지예요.',
