...
export const OSAKA_PASSES: TransitPass[] = [
  {
    ...
    breakEven: '유료 관광지 2곳 이상이면 이득',
    worthIt:
      '이 패스는 교통보다 입장료로 뽑는 거예요. 오사카성 천수각이 1,200엔으로 올라서, 천수각과 공중정원 두 곳만 들어가도 지하철값까지 치면 본전이 넘어요. 지하철만 탈 거라면 오히려 손해예요.',
    whereToBuy: [
...
export const OSAKA_ADVISORY: PassAdvisory = {
    ...
    body: '주유패스(3,500엔)의 값어치는 지하철이 아니라 관광시설 무료 입장에 있어요. 오사카성 천수각이 1,200엔으로 오르면서, 천수각과 공중정원 두 곳만 들어가도 지하철값까지 치면 본전이 넘어요. 지하철만 탈 거면 에코카드(평일 820엔)가 훨씬 나아요. 다만 시설마다 시간 조건이 붙는 게 있으니 그날 동선부터 보세요.',
  };
